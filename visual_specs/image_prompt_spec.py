...
from intelligence.schema import ComplexityLevel, SlideIntelligence
from enhancement.schema import EnhancedSlide
from visual_specs.schema import AIImageSpec
...
def _select_camera_angle(intel: SlideIntelligence) -> str:
    ...
    from intelligence.schema import PresentationIntent
